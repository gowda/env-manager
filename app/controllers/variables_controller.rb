class VariablesController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @variable.update(variable_params)
        format.html { redirect_to @variable, notice: "Variable was successfully updated.", status: :see_other }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to variables_path, notice: "Variable was successfully destroyed.", status: :see_other }
  ...
  private
    ...
    def set_variable
      @variable = Variable.find(params.expect(:id))
    end
